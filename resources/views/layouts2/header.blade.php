...
<div class="app-header header top-header">
    <div class="container">
        <div class="d-flex">
            ...
            <style>
                /* Custom styles for the dropdown and badge */
                .animated-badge {
                ...
                .dropdown-item svg {
                    ...
                    /* Transition for SVG fill color */
                }

                .dropdown-item:hover svg {
                    fill: white !important;
                    /* Ensure SVG icon also changes color on hover */
                }
                ...
                .header-icon {
                    ...
                    /* Align SVG icon nicely with text */
                }
            ...
            $admin = User::find(Session::get('LoggedAdmin'));
            ...
            {{-- <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="notificationDropdown"
                    ...
                    <svg class="header-icon me-2" viewBox="0 0 24 24" width="20" height="20" fill="currentColor"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M12 22c1.1 0 1.99-.9 1.99-2H10c0 1.1.89 2 2 2zm6-6V9.5c0-3.07-1.63-5.64-4.5-6.32V2a1.5 1.5 0 0 0-3 0v1.18C7.63 3.86 6 6.43 6 9.5V16l-2 2v1h16v-1l-2-2z" />
                    </svg>
                    <span class="d-inline-flex align-items-center">
                        Notifications
                        <span class="badge bg-danger animated-badge ms-2">
                            {{ count($notifications) }}
                        </span>
                    </span>
                </a>
                <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 animated-dropdown"
                    aria-labelledby="notificationDropdown">
                    <li class="dropdown-header text-uppercase fw-bold text-muted">New Notifications</li>
                    <li>
                    ...
                    @forelse ($notifications as $notification)
                        <li>
                            <a class="dropdown-item d-flex align-items-center"
                                ...
                                <span class="me-2">{{ $notification->data['icon'] ?? '🔔' }}</span>
                                <span>{{ $notification->data['message'] ?? 'New update available.' }}</span>
                            </a>
                        </li>
                    @empty
                ...
                <div class="dropdown header-notify pl-4">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
                        <a href="#" class="dropdown-item d-flex pb-3">
                            <svg class="header-icon mr-4" x="1008" y="1248" viewBox="0 0 24 24" height="100%"
                ...
                <div class="dropdown profile-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                        <div class="text-center">
                            <a href="#" class="dropdown-item text-center user pb-0 font-weight-bold">John
                                Thomson</a>
