					...
					<div class="container">
						<div class="d-flex">
							<a class="header-brand text-left" href="{{ url('/' . $page='index') }}">
								...
								<img src="{{URL::asset('assets2/images/brand/favicon1.png')}}" class="header-brand-img darkmobile-logo" alt="Dashtic logo">
							</a>
							...
							<div class="d-flex order-lg-2 ml-auto">
								...
								<div class="dropdown profile-dropdown">
									<a href="#" class="nav-link pr-0 leading-none" data-toggle="dropdown">
										<span>
											<img src="{{URL::asset('assets2/images/users/16.jpg')}}" alt="img" class="avatar avatar-md brround">
										</span>
									</a>
									<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
