            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row text-center">
                        <div class="col-md-12">
                            <img src="{{ URL::asset('assets2/images/photos/award.png') }}" alt="img"
                                class="sales-img">
                            <h2 class="mb-0 mt-4 fs-40 counter font-weight-bold">$1000k</h2>
                            <span class="text-muted"><span class="text-green mr-1"><i
                                        class="fe fe-arrow-up ml-1"></i>0.82%</span> since last year</span>
                ...
                <div class="card-body">
                    <div class="scrollbar h-400" id="scrollbar">
                        <div class="d-flex mb-5">
                            <a href="#" class="mr-4">
                                <img class="w-8 h-8 rounded shadow" src="{{ URL::asset('assets2/images/orders/1.jpg') }}"
                                    alt="media1">
                            </a>
                            <div class="mt-3">
                        ...
                        <div class="d-flex mb-5">
                            <a href="#" class="mr-4">
                                <img class="w-8 h-8 rounded shadow" src="{{ URL::asset('assets2/images/orders/2.jpg') }}"
                                    alt="media1">
                            </a>
                            <div class="mt-3">
                        ...
                        <div class="d-flex mb-5">
                            <a href="#" class="mr-4">
                                <img class="w-8 h-8 rounded shadow" src="{{ URL::asset('assets2/images/orders/3.jpg') }}"
                                    alt="media1">
                            </a>
                            <div class="mt-3">
                        ...
                        <div class="d-flex mb-5">
                            <a href="#" class="mr-4">
                                <img class="w-8 h-8 rounded shadow" src="{{ URL::asset('assets2/images/orders/4.jpg') }}"
                                    alt="media1">
                            </a>
                            <div class="mt-3">
                        ...
                        <div class="d-flex mb-5">
                            <a href="#" class="mr-4">
                                <img class="w-8 h-8 rounded shadow" src="{{ URL::asset('assets2/images/orders/5.jpg') }}"
                                    alt="media1">
                            </a>
                            <div class="mt-3">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets2/images/orders/7.jpg') }}" alt="media1"> New
                                            Book</td>
                                        <td>#12323423</td>
                                    ...
                                    <tr>
                                        <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets2/images/orders/8.jpg') }}" alt="media1"> New
                                            Bowl</td>
                                        <td>#26762768</td>
                                        <td>11th July, 10am</td>
                                        <td class="font-weight-bold">$13,206</td>
                                    ...
                                    <tr>
                                        <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets2/images/orders/9.jpg') }}" alt="media1">
                                            Modal Car</td>
                                        <td>#76273277</td>
                                        <td>11th July, 10am</td>
                                        <td class="font-weight-bold">$13,206</td>
                                    ...
                                    <tr>
                                        <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets2/images/orders/10.jpg') }}" alt="media1">
                                            Headset</td>
                                        <td>#67237267</td>
                                        <td>11th July, 10am</td>
                                        <td class="font-weight-bold">$13,206</td>
                                    ...
                                    <tr>
                                        <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets2/images/orders/11.jpg') }}" alt="media1">
                                            New Headset</td>
                                        <td>#561527167</td>
                                        <td>11th July, 10am</td>
                                        <td class="font-weight-bold">$13,206</td>
                                    ...
                                    <tr>
                                        <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets2/images/orders/12.jpg') }}" alt="media1">
                                            Watch</td>
                                        <td>#12323423</td>
                                        <td>11th July, 10am</td>
                                        <td class="font-weight-bold">$13,206</td>
                                    ...
                                    <tr>
                                        <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets2/images/orders/13.jpg') }}" alt="media1">
                                            Branded Shoes</td>
                                        <td>#26762768</td>
                                        <td>11th July, 10am</td>
                                        <td class="font-weight-bold">$13,206</td>
                                    ...
                                    <tr>
                                        <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets2/images/orders/14.jpg') }}" alt="media1">
                                            New Modal shoe</td>
                                        <td>#12323423</td>
                                        <td>11th July, 10am</td>
                                        <td class="font-weight-bold">$13,206</td>
                                    ...
                                    <tr>
                                        <td class="font-weight-bold"><img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets2/images/orders/5.jpg') }}" alt="media1">
                                            Branded Shoes</td>
                                        <td>#26762768</td>
                                        <td>11th July, 10am</td>
                                        <td class="font-weight-bold">$13,206</td>
                        ...
                        <div class="table-responsive">
                            <table class="table transaction-table mb-0">
                                <tbody>
                                    <tr>
                                        <td class="d-flex">
                                            <img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets2/images/users/1.jpg') }}" alt="media1">
                                            <div class="mt-2">
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            <img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets2/images/users/4.jpg') }}" alt="media1">
                                            <div class="mt-2">
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            <img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets2/images/users/5.jpg') }}" alt="media1">
                                            <div class="mt-2">
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            <img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets2/images/users/2.jpg') }}" alt="media1">
                                            <div class="mt-2">
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            <img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets2/images/users/10.jpg') }}" alt="media1">
                                            <div class="mt-2">
                                    ...
                                    <tr>
                                        <td class="d-flex">
                                            <img class="w-7 h-7 rounded shadow mr-3"
                                                src="{{ URL::asset('assets2/images/users/12.jpg') }}" alt="media1">
                                            <div class="mt-2">
                    ...
                    <div class="card-options">
                        <div class="btn-group ml-5 mb-0">
                            <button type="button" class="btn btn-white dropdown-toggle" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"><i class="fe fe-plus"></i> Add New
                                Order</button>
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="#"><i class="fa fa-plus mr-2"></i>Add new Order</a>
                                <a class="dropdown-item" href="#"><i class="fa fa-eye mr-2"></i>View all new
                                    tab</a>
