...
<!-- <section style="background-image: url('assets1/images/banner-12.png'); background-repeat: no-repeat; background-size: cover; background-position: center;">
    <div class="container-lg py-5">
        <div class="row align-items-center">

            <div class="col-lg-6 pt-5 mt-4 text-white">
                <div style="background: rgba(0, 0, 0, 0.4); padding: 30px; border-radius: 15px;">
                    <h2 class="display-1 ls-1">
                        <span class="fw-bold" style="color: #FF69B4">Shanana</span> Beauty Products
                    </h2>
                    <p style="font-size: 1.4rem;">Beauty and bedroom must-haves, all in one place.</p>
                    ...
                    <div class="row my-5 text-white">
                        <div class="col">
                            <div class="d-flex align-items-center">
                                <h3 class="fw-bold mb-0 me-2">200+</h3>
                                <p class="mb-0 text-uppercase">Product Varieties</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="d-flex align-items-center">
                                <h3 class="fw-bold mb-0 me-2">20k+</h3>
                                <p class="mb-0 text-uppercase">Happy Customers</p>
                            </div>
                        </div>
                        <div class="col">
                            <div class="d-flex align-items-center">
                                <h3 class="fw-bold mb-0 me-2">20+</h3>
                                <p class="mb-0 text-uppercase">Store Locations</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6 mt-5 mt-lg-0">
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-1 g-4 justify-content-center">
                    <div class="col">
                        <div class="card info-card text-center">
                            ...
                            <h5>Freshly Made</h5>
                            <p>Handcrafted in small batches to ensure top quality and lasting freshness.</p>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card info-card text-center">
                            ...
                            <h5>100% Organic</h5>
                            <p>Made with natural and organic ingredients, gentle for all skin types.</p>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card info-card text-center">
                            ...
                            <h5>Fast Shipping</h5>
                            <p>Your beauty essentials, delivered fast and hassle-free.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- <section
        ...
        <div class="container-lg py-5">
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 pt-5 mt-4 text-white animate-fade-in-left">
                    <div class="glass-card p-4 rounded-4 shadow-lg">
                        <h2 class="display-2 fw-bold mb-3">
                            <span style="color: #FF69B4;">Shanana</span> Beauty Products
                        </h2>
                        <p class="fs-5 text-light">Beauty and bedroom must-haves, all in one place.</p>

                        <div class="d-flex flex-wrap gap-3 mt-4">
                            <a href="#" class="btn btn-lg btn-pink rounded-pill px-4 py-2">Start Shopping</a>
                            <a href="#" class="btn btn-outline-light btn-lg rounded-pill px-4 py-2">Join Now</a>
                        </div>

                        <div class="row mt-5 text-light">
                            <div class="col">
                                <div class="d-flex align-items-center">
                                    <h3 class="fw-bold me-2 mb-0">200+</h3>
                                    <p class="mb-0 text-uppercase">Product Varieties</p>
                                </div>
                            </div>
                            <div class="col">
                                <div class="d-flex align-items-center">
                                    <h3 class="fw-bold me-2 mb-0">20k+</h3>
                                    <p class="mb-0 text-uppercase">Happy Customers</p>
                                </div>
                            </div>
                            <div class="col">
                                <div class="d-flex align-items-center">
                                    <h3 class="fw-bold me-2 mb-0">20+</h3>
                                    <p class="mb-0 text-uppercase">Store Locations</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 mt-5 mt-lg-0 animate-fade-in-right">
                    <div class="row g-4">
        ...
        <!-- <section
        style="background-image: url('assets1/images/banner-12.png'); background-repeat: no-repeat; background-size: cover; background-position: center; position: relative; overflow: hidden;"
        class="stunning-section">
        <div class="overlay"></div>
        <div class="container-fluid custom-container py-5">
            <div class="row align-items-center gx-5">

                <div class="col-lg-7 animate-fade-in-left order-lg-2 mb-5 mb-lg-0">
                    <div
                        class="glass-panel hero-panel p-5 rounded-5 shadow-lg d-flex flex-column justify-content-center text-white text-center text-lg-start">
                        <h1 class="display-1 fw-extrabold mb-3 glitch-effect">
                            <span class="highlight-pink">Shanana</span> Beauty Products
                        </h1>
                        <p class="fs-4 mb-4 text-light fade-in-text">Beauty and bedroom must-haves, all in one place.
                        </p>

                        <div class="d-flex flex-wrap gap-4 mb-5 justify-content-center justify-content-lg-start">
                            <a href="#"
                                class="btn btn-pink btn-lg rounded-pill px-5 py-3 shadow button-glow">Start
                                Shopping</a>
                            <a href="#"
                                class="btn btn-outline-light btn-lg rounded-pill px-5 py-3 shadow button-glow">Join
                                Now</a>
                        </div>

                        <div
                            class="stats d-flex flex-column flex-md-row justify-content-around text-center text-white gap-4">
                            <div class="stat-item">
                                <h3 class="fw-bold mb-1 animated-number" data-target="200">0</h3>
                                <small class="text-uppercase letter-spacing">Product Varieties</small>
                            </div>
                            <div class="stat-item">
                                <h3 class="fw-bold mb-1 animated-number" data-target="20000">0</h3>
                                <small class="text-uppercase letter-spacing">Happy Customers</small>
                            </div>
                            <div class="stat-item">
                                <h3 class="fw-bold mb-1 animated-number" data-target="20">0</h3>
                ...
                <div class="col-lg-5 animate-fade-in-right order-lg-1">
                    <div class="glass-panel info-panel p-5 rounded-5 shadow-lg">
                        <h3 class="text-white mb-4 fw-bold text-center glow-text">Why Choose Us?</h3>
                        <div class="row gy-4">
                            <div class="col-12">
                                <div class="info-card shadow-lg text-center p-4 rounded-4 reveal-item"
                                    data-delay="0.1s">
                                    <div class="info-icon">
        ...
        <style>
            ...
            .glass-panel {
                ...
                box-shadow: 0 10px 40px 0 rgba(255, 105, 180, 0.3);
            ...
            .glass-panel:hover {
                box-shadow: 0 15px 50px 0 rgba(255, 105, 180, 0.7);
                transform: translateY(-5px);
            ...
            .hero-panel {
                ...
                position: relative;
                overflow: hidden;
                background: linear-gradient(135deg, rgba(255, 105, 180, 0.15), rgba(255, 255, 255, 0.05));

            }

            .hero-panel .highlight-pink {
                color: #ff69b4;
                text-shadow: 0 0 15px #ff69b4, 0 0 25px rgba(255, 105, 180, 0.8);
            ...
            @keyframes glitch {
                ...
                20% {
                    text-shadow: 2px 2px 0px #ff69b4, -2px -2px 0px #fff;
                }
            ...
            .btn-pink:hover {
                ...
                box-shadow: 0 12px 30px rgba(255, 0, 127, 0.9);
                color: #fff;
            ...
            .btn-outline-light:hover {
                ...
                transform: scale(1.05) translateY(-3px);
                box-shadow: 0 12px 30px rgba(255, 0, 127, 0.7);
            }
            ...
            @keyframes buttonPulse {
                ...
                50% {
                    box-shadow: 0 12px 30px rgba(255, 0, 127, 1);
                }
            ...
            .info-card:hover .info-icon {
                box-shadow: 0 0 30px #ff69b4, 0 0 50px rgba(255, 105, 180, 0.8);
            ...
            @media (max-width: 992px) {
                ...
                .d-flex.flex-wrap.gap-4.mb-5.justify-content-center.justify-content-lg-start {
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                animatedNumbers.forEach(num => {
                    ...
                    function animate(currentTime) {
                        ...
                        if (progress < 1) {
                            num.textContent = Math.floor(start + progress * (target - start)).toLocaleString();
                    ...
                    <div class="category-carousel swiper">
                        <div class="swiper-wrapper">
                            <a href="category.html" class="nav-link swiper-slide text-center">
                                <img src="/assets1/images/category-thumb-1.jpg" class="rounded-circle"
                                    alt="Category Thumbnail">
                                <h4 class="fs-6 mt-3 fw-normal category-title">Fruits & Veges</h4>
                            </a>
                            <a href="category.html" class="nav-link swiper-slide text-center">
                                <img src="/assets1/images/category-thumb-2.jpg" class="rounded-circle"
                                    alt="Category Thumbnail">
                                <h4 class="fs-6 mt-3 fw-normal category-title">Breads & Sweets</h4>
                            </a>
                            <a href="category.html" class="nav-link swiper-slide text-center">
                                <img src="/assets1/images/category-thumb-3.jpg" class="rounded-circle"
                                    alt="Category Thumbnail">
                                <h4 class="fs-6 mt-3 fw-normal category-title">Fruits & Veges</h4>
                            </a>
                            <a href="category.html" class="nav-link swiper-slide text-center">
                                <img src="/assets1/images/category-thumb-4.jpg" class="rounded-circle"
                                    alt="Category Thumbnail">
                                <h4 class="fs-6 mt-3 fw-normal category-title">Beverages</h4>
                            </a>
                            <a href="category.html" class="nav-link swiper-slide text-center">
                                <img src="/assets1/images/category-thumb-5.jpg" class="rounded-circle"
                                    alt="Category Thumbnail">
                                <h4 class="fs-6 mt-3 fw-normal category-title">Meat Products</h4>
                            </a>
                            <a href="category.html" class="nav-link swiper-slide text-center">
                                <img src="/assets1/images/category-thumb-6.jpg" class="rounded-circle"
                                    alt="Category Thumbnail">
                                <h4 class="fs-6 mt-3 fw-normal category-title">Breads</h4>
                            </a>
                            <a href="category.html" class="nav-link swiper-slide text-center">
                                <img src="/assets1/images/category-thumb-7.jpg" class="rounded-circle"
                                    alt="Category Thumbnail">
                                <h4 class="fs-6 mt-3 fw-normal category-title">Fruits & Veges</h4>
                            </a>
                            <a href="category.html" class="nav-link swiper-slide text-center">
                                <img src="/assets1/images/category-thumb-8.jpg" class="rounded-circle"
                                    alt="Category Thumbnail">
                                <h4 class="fs-6 mt-3 fw-normal category-title">Breads & Sweets</h4>
                            </a>
                            <a href="category.html" class="nav-link swiper-slide text-center">
                ...
                <div class="col-md-12">
                    ...
                    <div class="banner-blocks">
                        ...
                        <div class="banner-ad bg-success-subtle block-2"
                            style="background:url('assets1/images/banner-ad-2.jpg') no-repeat;background-size: cover">
                        ...
                        <div class="banner-ad bg-danger block-3"
                            style="background:url('assets1/images/banner-ad-3.jpg') no-repeat;background-size: cover">
                            <div class="banner-content align-items-center p-5">
                                <div class="content-wrapper text-light">
            ...
            <div class="row">
                <div class="col-md-4">
                    <article class="post-item card border-0 shadow-sm p-3">
                        <div class="image-holder zoom-effect">
                            <a href="#">
                                <img src="/assets1/images/post-thumbnail-1.jpg" alt="post"
                                    class="card-img-top">
                            </a>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <article class="post-item card border-0 shadow-sm p-3">
                        <div class="image-holder zoom-effect">
                            <a href="#">
                                <img src="/assets1/images/post-thumbnail-2.jpg" alt="post"
                                    class="card-img-top">
                            </a>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-4">
                    <article class="post-item card border-0 shadow-sm p-3">
                        <div class="image-holder zoom-effect">
                            <a href="#">
                                <img src="/assets1/images/post-thumbnail-3.jpg" alt="post"
                                    class="card-img-top">
                            </a>
                        </div>
                        <div class="card-body">
